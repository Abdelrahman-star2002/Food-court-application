...
class laroma : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        oo.setOnClickListener {
            val intent = Intent(this@laroma, laromaorders::class.java)
            startActivity(intent)
        }

        call=findViewById(R.id.callbutton)
        call.setOnClickListener {
            val intent = Intent(this@laroma, callActivity::class.java)
            startActivity(intent)
        }

        deliveryyes?.setOnClickListener(View.OnClickListener {
            val db = FirebaseDatabase.getInstance().reference.child("FOODY")
            val path = "lamora/delivery"
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@laroma, map::class.java)
            startActivity(intent)
        })
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@laroma, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
    private fun addInfo() {
