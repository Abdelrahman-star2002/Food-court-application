...
class pronto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        oo.setOnClickListener {
            val intent = Intent(this@pronto, prontooders::class.java)
            startActivity(intent)
        }

        call=findViewById(R.id.callbutton)
        call.setOnClickListener {
            val intent = Intent(this@pronto, callActivity::class.java)
            startActivity(intent)
        }

        deliveryyes?.setOnClickListener(View.OnClickListener {
            val db = FirebaseDatabase.getInstance().reference.child("FOODY")
            val path = "pronto/delivery"
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@pronto, map::class.java)
            startActivity(intent)
        })
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@pronto, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
    private fun addInfo() {
