...
class arabiatacoustmer : AppCompatActivity() {
    ...
    val restaurantNames = listOf( "arabiata")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val delivery = "arabiata/delivery"
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@arabiatacoustmer, mapcoustmer::class.java)
    ...
    private fun showorderstatus() {
        ...
        val db = FirebaseDatabase.getInstance().reference.child("FOODY").child("arabiata").child("orders")
    ...
    private fun addInfo() {
        ...
        for (restaurantName in restaurantNames) {
            db.child("arabiata").child("carts").addListenerForSingleValueEvent(object :
                ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
        ...
        addDialog.setPositiveButton("Ok") { dialog, _ ->
            ...
            val intent = Intent(this@arabiatacoustmer, donecustomer::class.java)
            startActivity(intent)
    ...
    private fun readDataFromDatabase() {
        val db = FirebaseDatabase.getInstance().reference.child("FOODY").child("arabiata").child("items")
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@arabiatacoustmer, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
