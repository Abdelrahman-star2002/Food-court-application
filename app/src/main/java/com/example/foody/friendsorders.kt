...
class friendsorders : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.friendsorders)
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@friendsorders, friends::class.java)
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@friendsorders, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
