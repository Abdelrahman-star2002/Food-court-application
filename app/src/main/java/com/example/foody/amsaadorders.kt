...
class amsaadorders : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.amsaad_orders_activity)
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@amsaadorders, amsaad::class.java)
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@amsaadorders, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
