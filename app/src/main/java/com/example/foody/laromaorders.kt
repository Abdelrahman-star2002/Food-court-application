...
class laromaorders : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.laroma_orders)
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@laromaorders, amsaad::class.java)
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@laromaorders, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
