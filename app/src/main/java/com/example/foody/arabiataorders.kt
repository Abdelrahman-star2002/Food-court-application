...
class arabiataorders : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.arabiata_orders)
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@arabiataorders, arabiata::class.java)
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@arabiataorders, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
