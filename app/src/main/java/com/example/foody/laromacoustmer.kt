...
class laromacoustmer : AppCompatActivity() {
    ...
    val restaurantNames = listOf("lamora")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@laromacoustmer, mapcoustmer::class.java)
    ...
    private fun showorderstatus() {
        ...
        val db = FirebaseDatabase.getInstance().reference.child("FOODY").child("lamora").child("orders")
    ...
    private fun addInfo() {
        ...
        for (restaurantName in restaurantNames) {
            db.child("lamora").child("carts").addListenerForSingleValueEvent(object :
                ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
        ...
        addDialog.setPositiveButton("Ok") { dialog, _ ->
            ...
            val intent = Intent(this@laromacoustmer, donecustomer::class.java)
            startActivity(intent)
    ...
    private fun readDataFromDatabase() {
        val db = FirebaseDatabase.getInstance().reference.child("FOODY").child("lamora").child("items")
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@laromacoustmer, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
