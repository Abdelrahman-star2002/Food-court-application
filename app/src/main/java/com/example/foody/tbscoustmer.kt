...
class tbscoustmer : AppCompatActivity() {
    ...
    val restaurantNames = listOf("tbs")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@tbscoustmer, mapcoustmer::class.java)
    ...
    private fun addInfo() {
        ...
        for (restaurantName in restaurantNames) {
            db.child("tbs").child("carts").addListenerForSingleValueEvent(object :
                ValueEventListener {
                override fun onDataChange(dataSnapshot: DataSnapshot) {
        ...
        addDialog.setPositiveButton("Ok") { dialog, _ ->
            ...
            val intent = Intent(this@tbscoustmer, donecustomer::class.java)
            startActivity(intent)
    ...
    private fun readDataFromDatabase() {
        val db = FirebaseDatabase.getInstance().reference.child("FOODY").child("tbs").child("items")
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@tbscoustmer, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
