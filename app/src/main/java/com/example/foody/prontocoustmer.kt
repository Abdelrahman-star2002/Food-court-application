...
class prontocoustmer : AppCompatActivity() {
    ...
    val restaurantNames = listOf("pronto")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@prontocoustmer, mapcoustmer::class.java)
    ...
    private fun addInfo() {
        ...
        for (restaurantName in restaurantNames) {
            db.child("pronto").child("carts").addListenerForSingleValueEvent(object :
                ValueEventListener {
        ...
        addDialog.setPositiveButton("Ok") { dialog, _ ->
            ...
            val intent = Intent(this@prontocoustmer, donecustomer::class.java)
            startActivity(intent)
    ...
    private fun readDataFromDatabase() {
        val db = FirebaseDatabase.getInstance().reference.child("FOODY").child("pronto").child("items")
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@prontocoustmer, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
