...
class arabiata : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        oo.setOnClickListener {
            val intent = Intent(this@arabiata, arabiataorders::class.java)
            startActivity(intent)
        }
        call=findViewById(R.id.callbutton)
        call.setOnClickListener {
            val intent = Intent(this@arabiata, callActivity::class.java)
            startActivity(intent)
        }

        deliveryyes?.setOnClickListener(View.OnClickListener {
            val db = FirebaseDatabase.getInstance().reference.child("FOODY")
            val path = "arabiata/delivery"
        ...
        goback?.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@arabiata, map::class.java)
            startActivity(intent)
        })
    ...
    private fun readDataFromDatabase() {
        ...
        db.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@arabiata, "Failed to read data", Toast.LENGTH_SHORT).show()
            }
        })
    }
    private fun addInfo() {
