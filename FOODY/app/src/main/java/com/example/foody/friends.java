...
public class friends extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path1 = "friends/items/americanespresso/price";
        ...
        String path2 = "friends/items/capuccino/price";
        ...
        String path3 = "friends/items/hotchocklate/price";
        ...
        String path4 = "friends/items/latte/price";
        ...
        String path5 = "friends/items/icecoffee/price";
        ...
        String path6 = "friends/items/lemon/price";
        ...
        String path7 = "friends/items/water/price";
        ...
        String path8 = "friends/items/corassont/price";
        ...
        String quantity1 = "friends/items/americanespresso/quantity";
        ...
        String quantity2 = "friends/items/capuccino/quantity";
        ...
        String quantity3 = "friends/items/hotchocklate/quantity";
        ...
        String quantity4 = "friends/items/latte/quantity";
        ...
        String quantity5 = "friends/items/icecoffee/quantity";
        ...
        String quantity6 = "friends/items/lemon/quantity";
        ...
        String quantity7 = "friends/items/water/quantity";
        ...
        String quantity8 = "friends/items/corassont/quantity";
        ...
        priceplus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/americanespresso/price";
        ...
        priceplus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/capuccino/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/hotchocklate/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/latte/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/icecoffee/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/lemon/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/water/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/corassont/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/americanespresso/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/capuccino/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/hotchocklate/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/latte/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/icecoffee/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/lemon/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/water/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "friends/items/corassont/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(friends.this,"server updated",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(friends.this,done.class);
