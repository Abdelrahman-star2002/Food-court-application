...
public class amsaad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path1 = "amsaad/items/folsada/price";
        ...
        String path2 = "amsaad/items/folbelbeed/price";
        ...
        String path3 = "amsaad/items/ta3meyasada/price";
        ...
        String path4 = "amsaad/items/ta3meyabelbeed/price";
        ...
        String path5 = "amsaad/items/batatesmahrosa/price";
        ...
        String path6 = "amsaad/items/batatesmehamara/price";
        ...
        String path7 = "amsaad/items/water/price";
        ...
        String path8 = "amsaad/items/cola/price";
        ...
        String quantity1 = "amsaad/items/folsada/quantity";
        ...
        String quantity2 = "amsaad/items/folbelbeed/quantity";
        ...
        String quantity3 = "amsaad/items/ta3meyasada/quantity";
        ...
        String quantity4 = "amsaad/items/ta3meyabelbeed/quantity";
        ...
        String quantity5 = "amsaad/items/batatesmahrosa/quantity";
        ...
        String quantity6 = "amsaad/items/batatesmehamara/quantity";
        ...
        String quantity7 = "amsaad/items/water/quantity";
        ...
        String quantity8 = "amsaad/items/cola/quantity";
        ...
        priceplus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/folsada/price";
        ...
        priceplus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/folbelbeed/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/ta3meyasada/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/ta3meyabelbeed/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/batatesmahrosa/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/batatesmehamara/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/water/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/cola/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/folsada/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/folbelbeed/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/ta3meyasada/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/ta3meyabelbeed/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/batatesmahrosa/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/batatesmehamara/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/water/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "amsaad/items/cola/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(amsaad.this,"server updated",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(amsaad.this,done.class);
