...
public class laroma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laroma);
        ...
        String path1 = "lamora/items/americanespresso/price";
        ...
        String path2 = "lamora/items/capuccino/price";
        ...
        String path3 = "lamora/items/hotchocklate/price";
        ...
        String path4 = "lamora/items/latte/price";
        ...
        String path5 = "lamora/items/icecoffee/price";
        ...
        String path6 = "lamora/items/lemon/price";
        ...
        String path7 = "lamora/items/water/price";
        ...
        String path8 = "lamora/items/corassont/price";
        ...
        String quantity1 = "lamora/items/americanespresso/quantity";
        ...
        String quantity2 = "lamora/items/capuccino/quantity";
        ...
        String quantity3 = "lamora/items/hotchocklate/quantity";
        ...
        String quantity4 = "lamora/items/latte/quantity";
        ...
        String quantity5 = "lamora/items/icecoffee/quantity";
        ...
        String quantity6 = "lamora/items/lemon/quantity";
        ...
        String quantity7 = "lamora/items/water/quantity";
        ...
        String quantity8 = "lamora/items/corassont/quantity";
        ...
        priceplus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/americanespresso/price";
        ...
        priceplus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/capuccino/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/hotchocklate/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/latte/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/icecoffee/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/lemon/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/water/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/corassont/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "lamora/items/latte/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(laroma.this,"server updated",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(laroma.this,done.class);
