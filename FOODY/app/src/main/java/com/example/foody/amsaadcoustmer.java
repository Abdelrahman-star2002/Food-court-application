...
public class amsaadcoustmer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pricee1 = "amsaad/items/folsada/price";
        ...
        String pricee2 = "amsaad/items/folbelbeed/price";
        ...
        String pricee3 = "amsaad/items/ta3meyasada/price";
        ...
        String pricee4 = "amsaad/items/ta3meyabelbeed/price";
        ...
        String pricee5 = "amsaad/items/batatesmahrosa/price";
        ...
        String pricee6 = "amsaad/items/batatesmehamara/price";
        ...
        String pricee7 = "amsaad/items/water/price";
        ...
        String pricee8 = "amsaad/items/cola/price";
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(amsaadcoustmer.this,"",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(amsaadcoustmer.this,checkout.class);
