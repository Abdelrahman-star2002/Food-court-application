...
public class prontocoustmer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prontocoustmer);
        ...
        String pricee1 = "pronto/items/americanespresso/price";
        ...
        String pricee2 = "pronto/items/cappucino/price";
        ...
        String pricee3 = "pronto/items/hotchocklate/price";
        ...
        String pricee4 = "pronto/items/latte/price";
        ...
        String pricee5 = "pronto/items/icecoffee/price";
        ...
        String pricee6 = "pronto/items/lemon/price";
        ...
        String pricee7 = "pronto/items/water/price";
        ...
        String pricee8 = "pronto/items/corassont/price";
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(prontocoustmer.this,"",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(prontocoustmer.this,checkout.class);
