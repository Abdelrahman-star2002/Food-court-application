...
public class tbscoustmer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tbscoustmer);
        ...
        String pricee1 = "tbs/items/americanespresso/price";
        ...
        String pricee2 = "tbs/items/capucchino/price";
        ...
        String pricee3 = "tbs/items/hotchocklate/price";
        ...
        String pricee4 = "tbs/items/latte/price";
        ...
        String pricee5 = "tbs/items/icecoffee/price";
        ...
        String pricee6 = "tbs/items/lemon/price";
        ...
        String pricee7 = "tbs/items/water/price";
        ...
        String pricee8 = "tbs/items/corassont/price";
        ...
        checkout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tbscoustmer.this,"",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(tbscoustmer.this,checkout.class);
