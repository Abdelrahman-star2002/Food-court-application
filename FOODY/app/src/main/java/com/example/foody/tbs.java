...
public class tbs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String path1 = "tbs/items/americanespresso/price";
        ...
        String path2 = "tbs/items/capucchino/price";
        ...
        String path3 = "tbs/items/hotchocklate/price";
        ...
        String path4 = "tbs/items/latte/price";
        ...
        String path5 = "tbs/items/icecoffee/price";
        ...
        String path6 = "tbs/items/lemon/price";
        ...
        String path7 = "tbs/items/water/price";
        ...
        String path8 = "tbs/items/corassont/price";
        ...
        String quantity1 = "tbs/items/americanespresso/quantity";
        ...
        String quantity2 = "tbs/items/capucchino/quantity";
        ...
        String quantity3 = "tbs/items/hotchocklate/quantity";
        ...
        String quantity4 = "tbs/items/latte/quantity";
        ...
        String quantity5 = "tbs/items/icecoffee/quantity";
        ...
        String quantity6 = "tbs/items/lemon/quantity";
        ...
        String quantity7 = "tbs/items/water/quantity";
        ...
        String quantity8 = "tbs/items/corassont/quantity";
        ...
        priceplus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/americanespresso/price";
        ...
        priceplus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/capucchino/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/hotchocklate/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/latte/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/icecoffee/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/lemon/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/water/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        priceplus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/corassont/price";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/americanespresso/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/capucchino/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/hotchocklate/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/latte/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/icecoffee/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/lemon/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/water/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        plus8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("FOODY");
                String path = "tbs/items/corassont/quantity";
                db.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        int x = snapshot.getValue(Integer.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tbs.this,"server updated",Toast.LENGTH_SHORT).show();
                Intent intent =new Intent(tbs.this,done.class);
